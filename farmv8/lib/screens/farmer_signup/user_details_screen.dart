  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          '${l10n.translate('step_x_of_y').replaceAll('{current}', '2').replaceAll('{total}', '5')} . ${l10n.translate('user_details')}',
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(l10n.translate('user_details'), style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Text(l10n.translate('user_details_sub'), style: const TextStyle(fontSize: 14, color: Colors.grey)),
              const SizedBox(height: 24),
              _buildTextField(l10n.translate('first_name'), _firstNameController, Icons.person_outline),
              _buildTextField(l10n.translate('middle_name'), _middleNameController, Icons.person_outline),
              _buildTextField(l10n.translate('last_name'), _lastNameController, Icons.person_outline),
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const FarmDetailsScreen()));
                  }
                },
