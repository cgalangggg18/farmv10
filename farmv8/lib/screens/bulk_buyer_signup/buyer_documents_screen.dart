      ...
      appBar: AppBar(
        ...
        title: Text(
          provider.model.isVerified 
              ...
              : '${l10n.translate('step_x_of_y').replaceAll('{current}', '4').replaceAll('{total}', '4')} . ${l10n.translate('documents')}',
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                _buildUploadBox(l10n, l10n.translate('biz_permit'), provider.model.businessPermitPath, () => _pickFile((path) => provider.updateDocuments(businessPermit: path)), l10n.translate('upload_hint'), isPdf: false, isReadOnly: provider.model.isVerified && !_isManualEditMode),
                _buildUploadBox(l10n, l10n.translate('bir_cert'), provider.model.birCertificatePath, () => _pickFile((path) => provider.updateDocuments(birCertificate: path)), l10n.translate('upload_hint'), isPdf: false, isReadOnly: provider.model.isVerified && !_isManualEditMode),
              ],
            ),
